...
namespace hzd {
    StayMissionModel::StayMissionModel() : BaseModel("停留事件","停留事件") {
    ...
    StayMissionModel::~StayMissionModel() {

    }

    QJsonObject StayMissionModel::save() const {
    ...
    QWidget *StayMissionModel::embeddedWidget() {
        return BaseModel::embeddedWidget();
    }

    void StayMissionModel::load(const QJsonObject &p) {
